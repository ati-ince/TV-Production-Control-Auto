...
_filelink= "../Model_Names.ini"



_file = '../sası_planı_09.03.2020' #bir ust dizinden almakta....
...
with open(_filelink) as f_server:
    lines_server = f_server.readlines()

# model_name_ini_list ekleyecegiz append...
for i in lines_server:
    if i[0] !='#':
        if i[0] != '[':
